		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				...
				<div
					...
					data-background="../assets/img/unsplash/Asikboy.jpg">
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							<div class="mb-5 pb-3">
								<h1 class="mb-2 display-4 font-weight-bold" id="greetings"></h1>
								<h5 class="font-weight-normal text-muted-transparent">Banjarmasin, Indonesia</h5>
							</div>
							AXIOO-2023 <a class="text-light bb" target="_blank" href="">Rizky dan
								Raihan</a> Lagi <a class="text-light bb" target="_blank" href="">Ambis</a>
						</div>
					</div>
				</div>
			</div>
